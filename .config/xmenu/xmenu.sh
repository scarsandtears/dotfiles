...
Edit config
	...
	Text Editor
		Neovim
			...
			options	st -e nvim $HOME/.config/nvim/lua/haunt/options.lua	
			keymaps	st -e nvim $HOME/.config/nvim/lua/haunt/keymaps.lua
			plugins	st -e nvim $HOME/.config/nvim/lua/haunt/plugins.lua
